...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PLACED', 'QUOTED', 'CONFIRMED', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('COD', 'BANK_TRANSFER', 'WHATSAPP');
